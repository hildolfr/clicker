...
Download the standalone executable: [Clicker.exe](https://github.com/hildolfr/clicker/releases/download/v2.1.3/Clicker.exe) (direct download link). No installation required!
